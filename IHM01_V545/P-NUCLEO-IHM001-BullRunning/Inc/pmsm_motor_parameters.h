...
#define RS                     1.03 /* Stator resistance , ohm*/
#define LS                     0.001140 /* Stator inductance, H
...
#define NOMINAL_CURRENT         23061
#define MOTOR_MAX_SPEED_RPM     3000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  14.3 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -23061 /*!< Demagnetization current */
