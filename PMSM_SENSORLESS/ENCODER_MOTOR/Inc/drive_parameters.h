...
#define MAX_APPLICATION_SPEED_RPM       5500 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,  
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       50 /*!< Number of speed  
                                                             measurement errors before 
                                                             main sensor goes in fault */
/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD              0.6 /*!<Maximum accepted 
                                                            variance on speed 
...
#define OBS_MEAS_ERRORS_BEFORE_FAULTS    50  /*!< Number of consecutive errors   
...
/* State observer constants */
#define CORD_GAIN1                       -20932
#define CORD_GAIN2                       20828

#define CORD_MEAS_ERRORS_BEFORE_FAULTS   50  /*!< Number of consecutive errors   
                                                           on variance test before a speed 
                                                           feedback error is reported */
...
#define PID_TORQUE_KP_DEFAULT         1000       
#define PID_TORQUE_KI_DEFAULT         3117
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           1000
#define PID_FLUX_KI_DEFAULT           3117
...
/* Speed control loop */ 
#define SPEED_LOOP_FREQUENCY_HZ       100 /*!<Execution rate of speed   
                                                      regulation loop (Hz) */
